<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KittingQAProcess.aspx.cs" Inherits="ALLCARD_CMS_v2.acms.KittingQAProcess" %>
...
<head>
    ...
    <title>Kitting QA Process | ACMS</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kitting / Quality Control</span> / QA Process </h4>
                            <!-- Layout Demo -->
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link" href="QualityControl.aspx">Receiving</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" href="KittingQAProcess.aspx">QA Process</a>
                                        </li>

                                    </ul>
                                    <div class="card mb-4">
                                        <h5 class="card-header">Filenames to Process</h5>
