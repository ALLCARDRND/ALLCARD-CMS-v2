<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataPreparation.aspx.cs" Inherits="ALLCARD_CMS_v2.acms.DataPreparation" %>
...
<head>
    ...
    <title>Data Preparation | ACMS</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Personalization / Data Preparation</span> / For Process</h4>
                            <!-- Layout Demo -->
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="javascript:void(0);">For Process</a>
                                        </li>
                                        <li class="nav-item active">
                                            <a class="nav-link" href="ParseData.aspx">Parse Data</a>
                                        </li>
                                        <li class="nav-item active">
                                    ...
                                    <div class="card mb-4">
                                        <h5 class="card-header">Receiving Filenames</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td><input class="form-check-input" type="checkbox" value="" id="defaultCheck3" /></td>
                        <td>01/04/2024 12:25:12</td>
                        <td>2024-45101-AB</td>
                        <td>Unionbank of the Philippines SSS</td>
                        <td>Unionbank of the Philippines</td>
                        <td>EF_Number_123_123_123 </td>
                        <td>100000</td>
