<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KittingProcess.aspx.cs" Inherits="ALLCARD_CMS_v2.acms.KittingProcess" %>
...
<head>
    ...
    <title>Kitting Process | ACMS</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kitting</span> / Process</h4>
                            <!-- Layout Demo -->
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="KittingProcess.aspx">Process</a>
                                        </li>
                                    </ul>
                                    <div class="card mb-4">
