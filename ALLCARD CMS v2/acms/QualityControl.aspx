<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityControl.aspx.cs" Inherits="ALLCARD_CMS_v2.acms.QualityControl" %>
...
<head>
    ...
    <title>Kitting QA Receiving| ACMS</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kitting / Quality Control</span> / Receiving </h4>
                            <!-- Layout Demo -->
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="QualityControl.aspx">Receiving</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="KittingQAProcess.aspx">QA Process</a>
                                        </li>
