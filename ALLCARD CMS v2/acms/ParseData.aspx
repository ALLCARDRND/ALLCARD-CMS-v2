<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParseData.aspx.cs" Inherits="ALLCARD_CMS_v2.acms.ParseData" %>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Personalization / Data Preparation</span> / Parse Data</h4>
                            <!-- Layout Demo -->
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <li class="nav-item active">
                                            <a class="nav-link " href="DataPreparation.aspx">For Process</a>
                                        </li>
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="ParseData.aspx">Parse Data</a>
                                        </li>
                                        <li class="nav-item active">
                                            <a class="nav-link" href="TransferData.aspx">Transfer</a>
                                        </li>
                                    </ul>
                                    <div class="card mb-4">
                                        <h5 class="card-header">Filename to Parse</h5>

                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label for="exampleFormControlSelect1" class="form-label">Select Parser</label>
                                                <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                                    <option selected></option>
                                                    <option value="1">UBP SSS Parser v1</option>
                                                    <option value="1">UBP SSS Parser v2</option>
                                                    <option value="1">UBP SSS Parser v3</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <div class="input-group">
                                                    <input
                                                        ...
                                                        aria-label="Upload"/>
                                                    <button class="btn btn-outline-primary" type="button" id="inputGroupFileAddon04">Parse</button>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                             ...
                                             Parse Completed <br />
                                            ------------------------------------------------------------ <br />
                                             EF_Number1_asdsadsad Quantity: 250 Parsed: 300 <br />
                                                     EF_Number1_asdsadsad Quantity: 250 Parsed: 300 <br />
                                        ------------------------------------------------------------
